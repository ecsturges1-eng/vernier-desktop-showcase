...
const CARD = { x: 322, w: 512 };
const READ_X = 900, READ_W = 260;
...
function Defend({ tw }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: "absolute", left: 40, top: 84, width: 760,
      ...
      {ENTRIES.map((e, i) => {
        ...
        return (
          <React.Fragment key={i}>
            <div style={{
              position: "absolute", left: 40, top: rowY(i) + 34, width: 224, textAlign: "right",
      ...
      {compact ? null : (
        <div style={{
          position: "absolute", left: 40, top: 700, width: 794,
