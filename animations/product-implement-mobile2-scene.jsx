  ...
  return (
    <div style={{
      ...
      {WORK.map((w, i) => {
        ...
        return (
          <div key={i} style={{
            position: "absolute", left: cardX(i), top: cardY(i), width: cardW(i), height: CARD_H,
...
function ImplementMobile2Piece() {
...
window.ImplementMobile2Piece = ImplementMobile2Piece;
