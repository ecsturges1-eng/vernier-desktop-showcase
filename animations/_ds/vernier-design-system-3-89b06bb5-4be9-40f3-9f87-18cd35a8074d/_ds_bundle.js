/* @ds-bundle: {"format":4,"namespace":"VernierDesignSystem_89b06b","components":[{"name":"Badge","sourcePath":"components/Badge/Badge.jsx"},{"name":"Button","sourcePath":"components/Button/Button.jsx"},{"name":"Figure","sourcePath":"components/Figure/Figure.jsx"},{"name":"Input","sourcePath":"components/Input/Input.jsx"},{"name":"Logo","sourcePath":"components/Logo/Logo.jsx"},{"name":"Panel","sourcePath":"components/Panel/Panel.jsx"},{"name":"Table","sourcePath":"components/Table/Table.jsx"}],"sourceHashes":{"components/Badge/Badge.jsx":"ee28d8c271b6","components/Button/Button.jsx":"e98b524dd33d","components/Figure/Figure.jsx":"fb9df2f72daf","components/Input/Input.jsx":"e294bdbf89a7","components/Logo/Logo.jsx":"0143685c1fc2","components/Panel/Panel.jsx":"59ac4fd82c4f","components/Table/Table.jsx":"0d8663fbc616","deck-stage.js":"f3d3d0a662c0","doc-page.js":"f52ae9c02fca"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.VernierDesignSystem_89b06b = window.VernierDesignSystem_89b06b || {});
...
const TONES = {
  ...
  accent: {
    ...
    color: 'var(--accent)',
    borderColor: 'var(--accent-series-4)'
  },
  positive: {
...
function Button({
  ...
  const base = {
    ...
    gap: 'var(--space-2)',
    transition: 'background var(--dur-swap-in) var(--ease-swap), color var(--dur-swap-in) var(--ease-swap)',
  ...
  const looks = {
    ...
    secondary: ink ? {
      ...
      borderColor: 'var(--ink-reversed-muted)'
    } : {
    ...
    quiet: {
      background: 'transparent',
      color: ink ? 'var(--accent-on-ink)' : 'var(--accent)',
      padding: PAD[size]
    }
  };
...
function Figure({
  ...
  const ink = tone === 'ink';
  const deltaColor = direction === 'down' ? 'var(--negative)' : direction === 'up' ? 'var(--positive)' : ink ? 'var(--ink-reversed-muted)' : 'var(--ink-muted)';
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      letterSpacing: 'var(--tracking-label)',
      textTransform: 'uppercase',
      color: ink ? 'var(--ink-reversed-muted)' : 'var(--ink-muted)'
    }
    ...
    style: {
      font: SIZES[size],
      color: ink ? 'var(--ink-reversed)' : 'var(--ink)',
      fontVariantNumeric: 'tabular-nums'
    }
  }, value), unit ? /*#__PURE__*/React.createElement("span", {
    style: {
      font: 'var(--type-data)',
      color: ink ? 'var(--ink-reversed-secondary)' : 'var(--ink-secondary)'
    }
...
const FILES = {
  'mark-ink': 'mark.svg',
  'mark-reversed': 'mark-reversed.svg',
  'monogram-ink': 'monogram.svg',
  'monogram-reversed': 'monogram-reversed.svg'
};
const RATIO = {
  mark: 1410 / 1446,
  monogram: 552 / 568
...
function Logo({
  ...
  const key = lockup + '-' + tone;
  const file = FILES[key] || FILES['mark-ink'];
  ...
  return React.createElement('img', {
    ...
    style: {
      ...
      height: h,
      width: 'auto',
      aspectRatio: String(RATIO[lockup] || RATIO.mark),
      ...style
    },
    ...rest
  });
...
function Panel({
  ...
  return /*#__PURE__*/React.createElement("section", _extends({
    style: {
      background: ink ? 'var(--surface-ink)' : 'var(--surface)',
      border: '1px solid ' + (ink ? 'var(--ink-reversed-border)' : 'var(--border)'),
      borderRadius: 'var(--radius)',
      padding: 'var(--pad-panel)',
      boxShadow: elevated ? 'var(--elevation-1)' : 'var(--elevation-0)',
      color: ink ? 'var(--ink-reversed)' : 'var(--ink)',
      ...style
    }
  }, rest), label ? /*#__PURE__*/React.createElement("div", {
...
function Table({
  ...
  const cell = col => ({
    ...
    font: col.numeric ? 'var(--type-data)' : 'var(--type-ui-sm)',
    letterSpacing: col.numeric ? 'var(--tracking-mono)' : undefined,
  ...
  }, caption) : null, /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, columns.map(col => /*#__PURE__*/React.createElement("th", {
    key: col.key,
    scope: "col",
    style: {
  ...
  }, col.label)))), /*#__PURE__*/React.createElement("tbody", null, rows.map((r, i) => /*#__PURE__*/React.createElement("tr", {
    key: i
